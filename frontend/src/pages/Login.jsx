    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-display font-extrabold text-slate-800 dark:text-slate-100">Welcome Back</h2>
          <p className="text-xs text-slate-400 mt-1">Access your AI Investment research terminal.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <Link to="/forgot-password" className="text-[10px] text-brand-500 hover:underline">Forgot password?</Link>
            </div>
            <div className="relative">
        ...
        <div className="text-center mt-6 text-xs text-slate-400">
          ...
          <Link to="/register" className="text-brand-500 hover:underline font-semibold">Sign up free</Link>
        </div>
      </motion.div>
    </div>
  );
